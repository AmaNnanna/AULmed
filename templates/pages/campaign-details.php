                        ...
                        <div class="textwidget custom-html-widget">
                            <?php while ($Campaign = mysqli_fetch_object($Campaigns)) : ?>
                                <div class="widget-social">
                                    ...
                                    <a href="https://api.whatsapp.com/send?&text=<?= $Campaign->campaignTopic ?>%0ARead Here:%20https://aulmed.org/pages/<?= $Campaign->id ?>/campaign-details" target="_blank"><i class="fab fa-whatsapp"></i></a>
                                    <a href="mailto:?Subject=<?= $Campaign->campaignTopic ?>&Body=<?= $Campaign->campaignTopic ?>%0ARead More: https://aulmed.org/pages/<?= $Campaign->id ?>/campaign-details " target="_blank"><i class="fa fa-envelope"></i></a>
                                </div>
                            <?php endwhile; ?>
                        </div>
                    </section>
