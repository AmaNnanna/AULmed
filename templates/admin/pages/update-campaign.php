            ...
            <div class="card">
                <div class="card-body">
                    <div class="comment-respond" id="respond">
                        ...
                        <form class="comment-form" id="commentform" action="/update_campaign" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="campaignImage" class="text-black font-w600">Upload an New Image</label>
                                        <input type="file" class="form-control" name="campaignImage" value="<?= $newUpdate->campaignImage ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="campaignDescription" value="<?= $newUpdate->campaignDescription ?>"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="firstContentArea" class="form-control" name="campaignDetails" value="<?= $newUpdate->campaignDetails ?>"></textarea>
                                    </div>
                                </div>
