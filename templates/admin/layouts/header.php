    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/admin/pages/admin-home" class="brand-logo">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item">
                                ...
                                <!-- <a href="https://acara.dexignzone.com/laravel/demo/email-inbox" class="dropdown-item ai-icon">
