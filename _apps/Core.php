...
class Core extends Model
{
	...
	//Create New Blog
	public function CreateNewBlog($heading, $postCreator, $shortDescription, $firstContent, $secondContent, $thirdContent, $blockQuote, $quoteAuthor, $videoLink, $secondImageHeading, $thirdImageHeading, $firstImage, $secondImage, $thirdImage) {

		$sql = "INSERT INTO blog_posts (heading, postCreator, shortDescription, firstContent, secondContent, thirdContent, blockQuote, quoteAuthor, videoLink, secondImageHeading, thirdImageHeading, firstImage, secondImage, thirdImage) VALUES ('$heading', '$postCreator', '$shortDescription', '$firstContent', '$secondContent', '$thirdContent', '$blockQuote', '$quoteAuthor', '$videoLink', '$secondImageHeading', '$thirdImageHeading', '$firstImage', '$secondImage', '$thirdImage')";
