 ...
 */
// constants
define("appname","AUL Medical Care Services");
define('app_title','');
define('appid','1');
...
define("domain", "https://aulmed.org/");
...
// define("db_password","");
// define("db","aulmedb");
define("db_user","aulmeg_nexindb");
define("db_password","nxRO(@)Z]9FPX1");
define("db","aulmeg_nexindb");
define("db_port",null);
